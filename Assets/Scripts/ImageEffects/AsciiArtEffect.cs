...
public class AsciiArtEffect : CustomImageEffectBase {
    ...
    protected override void UpdateMaterial()
    {
        ...
        material.SetInt("_DivNumX", width / (fontWidth * fontScale));
        material.SetInt("_DivNumY", height / (fontHeight * fontScale));
    }
    ...
    protected override void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        var smallTex = RenderTexture.GetTemporary(width / (fontWidth * fontScale), height / (fontHeight * fontScale));
